...
![image-20210310232337109](images/image-20210310232337109.png)

## T(n) 

T(n) 是在输入数据量为 n 的情况下, 代码中语句的执行次数. - 衡量代码执行速度的依据

但是当数据量比较大的时候, 以及递归这种复杂的情况, T(n) 使用起来有点麻烦. 

因此, 算法一般使用 T(n) 简化的估算值, 即时间复杂度, 描述算法快慢.

## T(n) 如何得出时间复杂度



![image-20210310233011319](images/image-20210310233011319.png)
...
![image-20210310233220819](images/image-20210310233220819.png)

以运行时间最长的分支, 作为时间复杂度的依据.

![image-20210310233403146](image-20210310233403146.png)

有分支条件, 也是以运行时间最长的分支为依据

![image-20210310233521330](images/image-20210310233521330.png)

## 常见但是奇怪的时间复杂度

![image-20210310233749840](images/image-20210310233749840.png)



![image-20210310234706645](images/image-20210310234706645.png)
...
![image-20210310235127921](images/image-20210310235127921.png)
...
![image-20210310235554714](images/image-20210310235554714.png)
...
- 喜欢炫酷的动画和优雅的页面
- 有意思. 可以开发网页和网站, 可以看见成果, 很有成就感
- 不断在创新. 前端的发展历程可以看出, 不断在推陈出新, 接触新的技术和了解新的想法令人感到开心有趣
- 开发有趣的应用. 开发一些小的应用, 做自己想做的事情
- 喜欢所见即所得的感觉

## 前端工程师要做什么

Web前端开发在产品开发环节中的作用变得越来越重要，而且需要专业的前端工程师才能做好。Web前端开发是一项很特殊的工作，涵盖的知识面非常广，既有具体的技术，又有抽象的理念。
...
- 我是一个做事全力以赴的人，一旦确定了目标，会用上自己全部的力量，直到成功，即使失败了也不留遗憾。为了今天和您的这场面试，我接到面试通知后就一直在做功课。
- 比较随和好相处，会为别人考虑，做事比较细心.
- 适应性比较强,  在环境改变的时候，首先要积极学习，其次要学会寻找帮助, 最重要的是要主动, 主动了解环境并将自己融入其中

缺点:

- 有时候会过分在意别人的感受，不敢直接表达不同意见，因为觉得会让对方丢面子，我也在努力提高自己的沟通能力，学会委婉地表达自己的观点

- 因此有时不会拒绝别人，同事找我帮忙都一概揽下，结果有时影响了自身的工作进度”，这是陈述缺点。

  "现在我自己也反思了这个问题，会安排好工作的优先顺序，向求助同事展示手头工作并给予自己何时可以帮忙的预计时间，让他自行决定是否求助，既不影响同事关系，又提高了自己的工作效率"
...
您好，如果是个人效率问题，我一定会努力提高效率，在合理的时间内完成工作安排，绝不用加班来弥补自己的工作效率问题；如果是工作需要我会义不容辞加班，我现在没有任何家庭负担，可以全身心的投入工作。但同样，我也会提高工作效率，减少不必要的加班。

## 谈谈朋友对你的评价

要点:

回答“谈谈朋友对你的评价”这个问题，要有的放矢，回答的内容最好和求职相关，正面积极、真实可信，能证明自己的能力或为人，凸显自己的品德或为人处事的原则，赢得面试官的好感。

> 示例回答:

- 我的朋友都说我做事情很执着，喜好钻研，定了一个目标就会坚持去实现，很有毅力
- 我喜欢交朋友，他们都觉得我比较随和好相处，会为别人考虑，做事比较细心

## 印象最深的失败经历

要点:

- 回答这个问题的重点应落在“经历”上，而非“失败”上。面试官不仅想了解你对失败的态度，更想听到货真价实的内容。
- 说一件自己印象深刻的事情，真实的才最容易感染别人。可以详细地描述一下失败经历中所碰到的困难、你的处理方法、失败后的总结和反思。给出的事实细节越详细越好，最好可以就失败的经历“重演一次”，当场提出新的解决方案。通过失败说成功，不要强调结果，要更多地说过程，说自己的体会、收获、成长。类似的面试问题“说说你的一次成功经历”等，回答思路与此大同小异。
- 描述中，除了自己的不足和失误，客观原因可以适当提及，要让面试官感觉你勇于担当、勤于思考、乐于改正。不要说太多自己的性格缺陷或消极心态，不宜太多抱怨。

> 示例回答:

我曾经作为某某活动的负责人{组织者、发起人等等}想组织了某某活动{参加某某实践项目}，期间我做了很多努力{比如}但是由于什么原因{网自己身上揽}，最终没能达到预期的效果。《下面是重点了，要着重说》虽然结果令人遗憾，但是从中我认识到了不足，也积累了经验，汲取的教训（谈自己的收获）。（最后要拔高）我认为失败是在所难免的，有时候失败比成功更能是人成长，经过我的锻炼和学习，我相信如果再经历相关的实践工作，我一定会做的更好！

## 你还有什么要问的

贵公司对新入公司的员工有没有什么培训项目，我可以参加吗？或者说贵公司的晋升机制是什么样的？企业将很欢迎，因为体现出你对学习的热情和对公司的忠诚度以及你的上进心。

你可以问关于岗位的问题，关于公司的产品问题，关于公司的项目问题等等。展示出你对这些的关心和对入职后的工作期待。

# 职业发展

## 介绍下前端学习经历

工作中学习, 工作之余自学, 能够顺利完成工作要求, 新技术感兴趣. 
...
一个是喜欢, 一直有开发出美丽优雅实用的应用的追求, 于是如何做到这点的只是都想学习. 

二个是在坚持的过程中通过多给自己正向的反馈, 通过小的成就感不断去激励促进自己.

## 专业的前端, 觉得应该掌握哪些知识

**计算机基础**

计算机网络/数据结构/算法/操作系统/设计模式
...
## 看过什么书, 怎么判断书上的知识一定是对的?

## 简单介绍自己, 知道哪些技术

PWA WebSocket、WebGL、客户端数据库/ flutter

## 个人比较厉害的技术

## 认为前端应该具备什么特点?

1. 高性能界面优雅的网站带来良好甚至极致的用户体验
2. 技术发展迅速满足在各种端设备开发前端页面的需求

## 如果直接按图来做, 有没有遇到页面上实现不了的功能? 遇到了怎么办?
